...
**Last updated:** M96 Parent Contract Authority CONTENT ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; M96B FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96A FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95 CLOSED / GIT-DURABLE / PM-ACCEPTED; M95 Git closure FINALIZED / COMMITTED / TAGGED / PUSHED; M95 durable PM acceptance ACCEPTED; Milestone 95C FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 95B FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 95A FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; M95D NOT AUTHORIZED; M96C NOT AUTHORIZED; Git remains authoritative for committed durability and publication.
**Aether version:** 0.2.0
**Current completed local milestone:** M96 Parent Contract Authority CONTENT ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; M96B Goal-First In-Memory Foundation FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96A Authoritative Goal / TaskContext / Canonical Plan Boundary FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95 CLOSED / GIT-DURABLE / PM-ACCEPTED; M95 parent contract EXACTLY PROVEN; M95 parent obligations ALL SATISFIED; M95 parent substantive obligations COMPLETE; M95 closure ledger GIT-DURABLE; M95 Git closure FINALIZED / COMMITTED / TAGGED / PUSHED; M95 durable PM acceptance ACCEPTED; Milestone 95C FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 95B FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 95A FINALIZED / GIT-DURABLE / PM-ACCEPTED.
**Current active milestone/module:** M96 Parent Contract Authority CONTENT ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; Authoritative Goal-to-Plan Cognitive Foundation; M96 OPEN; Goal admission SATISFIED; Task SATISFIED; TaskContext SATISFIED; Canonical Plan runtime NOT YET SATISFIED; Canonical PlanStep runtime NOT YET SATISFIED; Think -> Plan consumer NOT YET SATISFIED; Governance-before-generic-Act runtime NOT YET SATISFIED; M96B FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96A FINALIZED / GIT-DURABLE / PM-ACCEPTED; selected model B; explicit context selection/switching; process-local foundation; Observation call-local; no API; no persistence; no /chat or loop wiring; no generic Act; M95 CLOSED / GIT-DURABLE / PM-ACCEPTED; M95D NOT AUTHORIZED; M96C NOT AUTHORIZED.
**Current status:** M96 Parent Contract Authority CONTENT ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; M96 parent contract authority content ESTABLISHED; Parent name Authoritative Goal-to-Plan Cognitive Foundation; M96 OPEN; Goal admission SATISFIED; Task SATISFIED; TaskContext SATISFIED; Canonical Plan runtime NOT YET SATISFIED; Canonical PlanStep runtime NOT YET SATISFIED; Think -> Plan consumer NOT YET SATISFIED; Governance-before-generic-Act runtime NOT YET SATISFIED; Goal -> accepted Goal -> Task -> initial authoritative TaskContext PROVEN; process-local only; dependency-injected clock; fresh semantic IDs; explicit human authority/provenance; one authoritative TaskContext per active Task; one selected TaskContext per reasoning turn only after explicit selection; silent context merge NO; immutable context snapshots YES; generic /chat execution authority NO; Observation call-local; no API; no persistence; no loop wiring; no Plan/PlanStep runtime; no Act; no Observation Intake; no Verification Aggregation; no Critic; no Repair; no Learning; M96B FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96A FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95D NOT AUTHORIZED; M96C NOT AUTHORIZED; governed capability count 1; restricted-read persistence BLOCKED; OpenAPI unchanged 306 paths / 112 schemas; api_server unchanged 8 direct @app routes / 23 include_router / 0 direct /action/*.
**Next milestone:** No subsequent M96 submilestone is authorized by this parent-authority record; any next M96 scope requires separate human/project-manager authorization. M96 remains OPEN; no production code, API, persistence, /chat or loop wiring, Plan/PlanStep runtime, generic Act, Observation Intake, Aggregation, Critic, Repair, Learning, background execution, scheduler, or M96C is authorized.
**Test baseline:** 2571 pre-93A full-suite baseline; 93A Boundary: 34 passed; New 93B: 26 passed; Canonical header: 23 passed; Current Progress-equivalent five-file family: 362 passed; 94A boundary: 24 passed; New 94B tests: 224 passed; 94C design-lock: 6 passed; 94D focused: 36 passed; M94 closure: 8 passed; 95A design-lock: 8 passed; 95B contract-lock: 10 passed; 95C consumer-proof lock: 10 passed; M96A design-boundary lock: 12 passed; M96B Goal-first foundation: 24 passed; M96 parent authority lock: 10 passed; Full candidate: 3034 passed; 9 existing PytestRemovedIn10Warning; warning occurrence delta versus parent: 0; Observation: 472 passed; Rule migration: 177 passed; OpenAPI family: 653 passed; OpenAPI: 306 paths / 112 schemas; api_server: 8 direct @app routes / 23 include_router / 0 direct /action/*.
...
**M95 authority:** CLOSED / GIT-DURABLE / PM-ACCEPTED; M95 parent contract EXACTLY PROVEN; M95 parent obligations ALL SATISFIED; M95 parent substantive obligations COMPLETE; M95 closure ledger GIT-DURABLE; M95 Git closure FINALIZED / COMMITTED / TAGGED / PUSHED; M95 closure tag milestone-95-parent-closure; M95 durable PM acceptance ACCEPTED; M95A is FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95B is FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95C is FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95D is NOT AUTHORIZED; M96A is FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96B is FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96 parent contract authority content is ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; M96 is OPEN; no runtime bridge, Observation Intake caller, persistent Observation Record, provenance envelope implementation, new API, new capability, generic execution, Aggregation, Critic, Repair, Learning, retry, background execution, scheduler, or consumer integration.
...
- **M96 Parent Contract Authority:** content ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; parent name Authoritative Goal-to-Plan Cognitive Foundation; Goal admission SATISFIED; Task SATISFIED; TaskContext SATISFIED; canonical Plan runtime NOT YET SATISFIED; canonical PlanStep runtime NOT YET SATISFIED; Think -> Plan consumer NOT YET SATISFIED; Governance-before-generic-Act runtime NOT YET SATISFIED; M96 OPEN; M96C NOT AUTHORIZED; 10 static authority-lock tests.
...
**M96 parent authority:** M96 Parent Contract Authority content ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; Authoritative Goal-to-Plan Cognitive Foundation; M96 OPEN; Goal admission SATISFIED; Task SATISFIED; TaskContext SATISFIED; canonical Plan runtime NOT YET SATISFIED; canonical PlanStep runtime NOT YET SATISFIED; Think -> Plan consumer NOT YET SATISFIED; Governance-before-generic-Act runtime NOT YET SATISFIED; M96B FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96A FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95D NOT AUTHORIZED; M96C NOT AUTHORIZED; M96B runtime remains process-local and unintegrated; no API, persistence, /chat or loop wiring, Plan/PlanStep runtime, generic Act, Observation Intake, Aggregation, Critic, Repair, Learning, retry, background execution, or scheduler.

**Status:** M96 parent contract authority content ESTABLISHED; Git determines commit/tag/publication state; PM acceptance is external; M96 OPEN; M96B Goal-First In-Memory Foundation FINALIZED / GIT-DURABLE / PM-ACCEPTED; M96A FINALIZED / GIT-DURABLE / PM-ACCEPTED; Goal -> accepted Goal -> Task -> initial authoritative TaskContext; current durable restricted-read consumer NONE; current call-local Observation and capability Verification remain authoritative; canonical Plan runtime NOT YET SATISFIED; canonical PlanStep runtime NOT YET SATISFIED; Think -> Plan consumer NOT YET SATISFIED; Governance-before-generic-Act runtime NOT YET SATISFIED; no runtime bridge; no Observation Intake caller; no persistent Observation Record; no provenance envelope runtime; no Verification Aggregation; no Critic; no Repair; no Learning; generic /chat execution authority NO; current Rule 4 physical ownership remains Core Governance; M95D NOT AUTHORIZED; M96C NOT AUTHORIZED; OpenAPI 306 paths / 112 schemas; api_server 8/23/0
...
**Next:** No subsequent M96 submilestone is authorized by this parent-authority record; any next M96 scope requires separate human/project-manager authorization. M96 is OPEN; no runtime persistence, API, /chat or loop wiring, Plan/PlanStep runtime, generic Act, Intake caller, provenance envelope implementation, consumer integration, scheduler, background execution, or M96C is authorized.
