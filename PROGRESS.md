...
**Last updated:** Milestone 95A Observation Provenance Source and Consumer-Proof Boundary Build complete locally; Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 95 OPEN; Git remains authoritative for committed durability and publication.
**Aether version:** 0.2.0
**Current completed local milestone:** Milestone 95A Observation Provenance Source and Consumer-Proof Boundary Build complete locally; Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; M95A status COMPLETE LOCALLY / PENDING PM REVIEW; M95B NOT AUTHORIZED.
**Current active milestone/module:** Milestone 95A Observation Provenance Source and Consumer-Proof Boundary; Milestone 95 OPEN; Milestone 94 is CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 94A is FINALIZED / DURABLE BOUNDARY; Milestone 94B is FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 94C is FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 94D is FINALIZED / GIT-DURABLE / PM-ACCEPTED; selected model B as a future provenance envelope; current runtime containment Model E; Rule 4 physical ownership is Core Governance; file.restricted_read; governed capability count 1; generic /chat execution authority NO; Observation call-local; M95B NOT AUTHORIZED.
**Current status:** Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 95 OPEN; Milestone 95A Observation Provenance Source and Consumer-Proof Boundary complete locally; M95A status COMPLETE LOCALLY / PENDING PM REVIEW; M95B NOT AUTHORIZED; selected model B; MODEL_B_JUSTIFIED; current runtime containment Model E; runtime decision M95_PROVENANCE_FOUNDATION_REQUIRED_BEFORE_RUNTIME; Observation call-local; no runtime bridge; no Observation Intake caller; no persistent Observation Record; no Verification Aggregation; no Critic; no Repair; no Learning; generic POST /chat does not execute real tools; generic /chat execution authority NO; capability file.restricted_read; governed capability count 1; POST /chat/restricted-read/resume; TWO_PHASE; APPROVE != EXECUTE; fresh execution-time Governance YES; Observation call-local; plan_step_id NOT_CURRENTLY_PROVABLE; collector_contract_id NOT_CURRENTLY_PROVABLE; expected_value NOT_CURRENTLY_PROVABLE; privacy-safe persistence NOT_SAFE_TO_PERSIST; current proven durable consumer NONE; OpenAPI: 306 paths / 112 schemas; api_server: 8 direct @app routes / 23 include_router / 0 direct /action/*.
**Next milestone:** human/project-manager review of Milestone 95A Observation Provenance Source and Consumer-Proof Boundary; no M95B implementation is authorized.
**Test baseline:** 2571 pre-93A full-suite baseline; 93A Boundary: 34 passed; New 93B: 26 passed; Canonical header: 23 passed; Current Progress-equivalent five-file family: 362 passed; 94A boundary: 24 passed; New 94B tests: 224 passed; 94C design-lock: 6 passed; 94D focused: 36 passed; M94 closure: 8 passed; 95A design-lock: 8 passed; Full candidate: 2968 passed; 9 existing PytestRemovedIn10Warning; warning occurrence delta versus parent: 0; Observation: 472 passed; Rule migration: 177 passed; OpenAPI family: 653 passed; OpenAPI: 306 paths / 112 schemas; api_server: 8 direct @app routes / 23 include_router / 0 direct /action/*.
...
**M95 authority:** OPEN; authorized scope is 95A Plan only; no runtime bridge, Observation Intake caller, persistent Observation Record, new API, new capability, generic execution, Aggregation, Critic, Repair, Learning, retry, or background execution.
**M95A status:** COMPLETE LOCALLY / PENDING PM REVIEW.
**M95B status:** NOT AUTHORIZED.
...
94D focused 36; M94 parent closure lock 8 static tests; M94 parent closure baseline 2960/2960 passed, 0 failures, 0 errors; current M95A candidate 2968/2968 passed, 0 failures, 0 errors; M94D pre-closure baseline 2952/2952.
...
**Status:** Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 95 OPEN; Milestone 95A Observation Provenance Source and Consumer-Proof Boundary Build complete locally; M95A status COMPLETE LOCALLY / PENDING PM REVIEW; M95B NOT AUTHORIZED; selected model B as a future provenance envelope; current runtime containment Model E; Observation call-local; no runtime bridge; no Observation Intake caller; no persistent Observation Record; no Verification Aggregation; no Critic; no Repair; no Learning; generic /chat execution authority NO; current Rule 4 physical ownership is Core Governance; OpenAPI 306 paths / 112 schemas; api_server 8/23/0.

**Next:** human/project-manager review of Milestone 95A Observation Provenance Source and Consumer-Proof Boundary. No M95B implementation is authorized.

### Historical M92C Closure Context

At the Milestone 92C closure boundary, current Rule 4 physical ownership is Core Governance; Milestone 92C is CLOSED / DURABLE; Candidate A-F remain deferred. This historical context does not override the canonical current M95A authority above.
