...
**Last updated:** Milestone 95B Minimal Observation Provenance Envelope Contract Foundation Build complete locally; Milestone 95A FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 95 OPEN; Git remains authoritative for committed durability and publication.
**Aether version:** 0.2.0
**Current completed local milestone:** Milestone 95B Minimal Observation Provenance Envelope Contract Foundation Build complete locally; Milestone 95A FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95B status COMPLETE LOCALLY / PENDING PM REVIEW.
**Current active milestone/module:** Milestone 95B Minimal Observation Provenance Envelope Contract Foundation; Milestone 95 OPEN; Milestone 95A is FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 94 is CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 94A is FINALIZED / DURABLE BOUNDARY; Milestone 94B is FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 94C is FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 94D is FINALIZED / GIT-DURABLE / PM-ACCEPTED; selected model B as a future provenance envelope; current runtime containment Model E; Rule 4 physical ownership is Core Governance; file.restricted_read; governed capability count 1; generic /chat execution authority NO; Observation call-local; M95B Plan / Contract / Source-Ownership Boundary only.
**Current status:** Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 95 OPEN; Milestone 95A FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 95B Minimal Observation Provenance Envelope Contract Foundation complete locally; M95B status COMPLETE LOCALLY / PENDING PM REVIEW; selected model B; MODEL_B_JUSTIFIED; current runtime containment Model E; runtime decision M95_PROVENANCE_FOUNDATION_REQUIRED_BEFORE_RUNTIME; Observation call-local; no runtime bridge; no Observation Intake caller; no persistent Observation Record; no Verification Aggregation; no Critic; no Repair; no Learning; generic POST /chat does not execute real tools; generic /chat execution authority NO; capability file.restricted_read; governed capability count 1; POST /chat/restricted-read/resume; TWO_PHASE; APPROVE != EXECUTE; fresh execution-time Governance YES; plan_step_id NOT_CURRENTLY_PROVABLE; collector_contract_id NOT_CURRENTLY_PROVABLE; expected_value CURRENT_INTAKE_EXPECTATION_MODEL_INCOMPATIBLE; privacy-safe persistence NOT_SAFE_TO_PERSIST; current proven durable consumer NONE; all future durable-admission gates UNPROVEN or OWNER_NOT_YET_DEFINED; M95C NOT AUTHORIZED; OpenAPI: 306 paths / 112 schemas; api_server: 8 direct @app routes / 23 include_router / 0 direct /action/*.
**Next milestone:** human/project-manager review of Milestone 95B Minimal Observation Provenance Envelope Contract Foundation; no runtime implementation, persistence, consumer integration, or M95C is authorized.
**Test baseline:** 2571 pre-93A full-suite baseline; 93A Boundary: 34 passed; New 93B: 26 passed; Canonical header: 23 passed; Current Progress-equivalent five-file family: 362 passed; 94A boundary: 24 passed; New 94B tests: 224 passed; 94C design-lock: 6 passed; 94D focused: 36 passed; M94 closure: 8 passed; 95A design-lock: 8 passed; 95B contract-lock: 10 passed; Full candidate: 2978 passed; 9 existing PytestRemovedIn10Warning; warning occurrence delta versus parent: 0; Observation: 472 passed; Rule migration: 177 passed; OpenAPI family: 653 passed; OpenAPI: 306 paths / 112 schemas; api_server: 8 direct @app routes / 23 include_router / 0 direct /action/*.
...
**M95 authority:** OPEN; M95A is FINALIZED / GIT-DURABLE / PM-ACCEPTED; M95B authorized scope is Plan / Contract / Source-Ownership Boundary only; no runtime bridge, Observation Intake caller, persistent Observation Record, new API, new capability, generic execution, Aggregation, Critic, Repair, Learning, retry, background execution, consumer integration, or M95C.
...
results. Current verified M95B results are: 93A 34; 93B 26; Canonical 23;
...
95B contract-lock 10; M94 parent closure baseline 2960/2960 passed, 0 failures,
0 errors; current M95B candidate 2978/2978 passed, 0 failures, 0 errors;
...
**Status:** Milestone 94 CLOSED / GIT-DURABLE / PM-ACCEPTED externally; Milestone 95 OPEN; Milestone 95A FINALIZED / GIT-DURABLE / PM-ACCEPTED; Milestone 95B Minimal Observation Provenance Envelope Contract Foundation complete locally; M95B status COMPLETE LOCALLY / PENDING PM REVIEW; selected model B as a future provenance envelope; current runtime containment Model E; Observation call-local; no runtime bridge; no Observation Intake caller; no persistent Observation Record; no Verification Aggregation; no Critic; no Repair; no Learning; generic /chat execution authority NO; current Rule 4 physical ownership is Core Governance; M95C NOT AUTHORIZED; OpenAPI 306 paths / 112 schemas; api_server 8/23/0.

**Next:** human/project-manager review of Milestone 95B Minimal Observation Provenance Envelope Contract Foundation. No M95B runtime implementation or M95C work is authorized.

### Historical M92C Closure Context

At the Milestone 92C closure boundary, current Rule 4 physical ownership is Core Governance; Milestone 92C is CLOSED / DURABLE; Candidate A-F remain deferred. This historical context does not override the canonical current M95B authority above.
