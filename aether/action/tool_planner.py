...
INFERENCE_RULES = [
    ("project.guided_proposal_decision_launcher.status", ["guided proposal decision launcher status", "\u63d0\u6848\u51b3\u5b9a\u542f\u52a8\u5668\u72b6\u6001"], "Request appears to inspect guided proposal decision launcher status."),
    ("project.guided_proposal_decision_launcher.summary", ["summarize guided proposal decision launcher", "guided proposal decision launcher summary", "\u603b\u7ed3\u63d0\u6848\u51b3\u5b9a\u542f\u52a8\u5668"], "Request appears to summarize a guided proposal decision."),
    ("project.guided_proposal_decision_launcher.submit", ["submit guided proposal decision", "submit proposal review decision", "approve guided proposal", "request changes for guided proposal", "reject guided proposal", "\u63d0\u4ea4\u5f15\u5bfc\u63d0\u6848\u51b3\u5b9a", "\u63d0\u4ea4\u63d0\u6848\u5ba1\u67e5\u51b3\u5b9a", "\u6279\u51c6\u5f15\u5bfc\u63d0\u6848", "\u8981\u6c42\u4fee\u6539\u5f15\u5bfc\u63d0\u6848", "\u62d2\u7edd\u5f15\u5bfc\u63d0\u6848"], "Request appears to submit an explicit guided proposal decision."),
    ("project.guided_proposal_review_launcher.status", ["guided proposal review launcher status", "\u63d0\u6848\u5ba1\u67e5\u542f\u52a8\u5668\u72b6\u6001"], "Request appears to inspect guided proposal review launcher status."),
    ("project.guided_proposal_review_launcher.summary", ["summarize guided proposal review launcher", "guided proposal review launcher summary", "\u603b\u7ed3\u63d0\u6848\u5ba1\u67e5\u542f\u52a8\u5668"], "Request appears to summarize a guided proposal review launch."),
    ("project.guided_proposal_review_launcher.open", ["open guided proposal review", "start proposal review from guided bridge selection", "open proposal review console", "open human proposal review", "\u4ece\u5f15\u5bfc\u6865\u63a5\u9009\u62e9\u6253\u5f00\u63d0\u6848\u5ba1\u67e5", "\u6253\u5f00\u63d0\u6848\u5ba1\u67e5\u63a7\u5236\u53f0", "\u542f\u52a8\u4eba\u5de5\u63d0\u6848\u5ba1\u67e5"], "Request appears to open guided proposal review."),
    ...
    ("project.final_real_apply_executor.open", ["open final real apply executor", "prepare final real apply", "final real apply ready", "打开最终真实应用执行器", "准备最终真实应用", "最终应用准备"], "Request appears to open final real-apply executor."),
    ...
    ("project.dry_run_review_gate.open", ["open dry run review gate", "review dry run result", "inspect dry run result", "dry run result review", "打开 dry run 审核", "审核 dry run 结果"], "Request appears to open dry-run result review."),
