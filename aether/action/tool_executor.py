...
def _safe_result(tool_id: str, payload: dict) -> dict:
    ...
    if tool_id == "project.proposal_revision_console.open": return open_proposal_revision_console(payload.get("source_type", ""), payload.get("source_id", ""), payload.get("metadata"))
    ...
    if tool_id == "project.approved_dry_run_gate.open": return open_approved_dry_run_gate(payload.get("source_type",""),payload.get("source_id",""),payload.get("metadata"))
    ...
    if tool_id == "project.real_apply_approval_gate.open": return open_real_apply_approval_gate(payload.get("source_type", ""), payload.get("source_id", ""), payload.get("create_approval_item", True), payload.get("metadata"))
    ...
    if tool_id == "project.post_apply_verification_gate.open": return open_post_apply_verification_gate(payload.get("source_type", ""),payload.get("source_id", ""),payload.get("metadata"))
    ...
    if tool_id == "project.repair_learning.create": return create_repair_learning_record(payload.get("source_type",""),payload.get("source_id",""),payload.get("export_public",True),payload.get("export_index",True),payload.get("export_private",True),payload.get("metadata"))
    if tool_id == "project.repair_learning.export_report": return export_repair_learning_report(payload.get("learning_record_id",""),payload.get("output_dir","docs/history/repair_learning"),payload.get("metadata"))
    if tool_id == "project.repair_learning.export_index": return export_repair_learning_index(payload.get("output_path","docs/history/repair_learning/INDEX.md"),payload.get("limit",100),payload.get("metadata"))
    ...
    if tool_id == "project.guided_repair_intake.open": return open_guided_repair_intake(payload.get("request_type",""),payload.get("requested_scope",""),payload.get("target_path"),payload.get("requester","human"),payload.get("guidance_record_id"),payload.get("create_guidance_if_missing",True),payload.get("export_public",True),payload.get("export_index",True),payload.get("export_private",True),payload.get("metadata"))
    if tool_id == "project.guided_repair_intake.submit_decision": return submit_guided_repair_intake_decision(payload.get("intake_record_id",""),payload.get("decision",""),payload.get("comment"),payload.get("reviewer","human"),payload.get("metadata"))
    if tool_id == "project.guided_repair_intake.summary": return summarize_guided_repair_intake(payload.get("record_id",""))
    if tool_id == "project.guided_repair_intake.status": return guided_repair_intake_status()
